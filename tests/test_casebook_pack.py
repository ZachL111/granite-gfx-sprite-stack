"""Regression checks for the granite-gfx-sprite-stack casebook."""
...
from casebook.harness import assert_expected, granite_gfx_sprite_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(granite_gfx_sprite_stack_summary(), assert_expected())
